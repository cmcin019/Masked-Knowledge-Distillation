...
# python3 -m torch.distributed.launch --nproc_per_node=1 eval_cls.py --arch vit_small --checkpoint_key "checkpoint_['dis'].pth" --output_dir out --batch-size 96 --lr 7.5e-6 --epochs 1 --data_set CIFAR10 --data_path data/CIFAR10
# python3 -m torch.distributed.launch --nproc_per_node=1 eval_cls.py --arch vit_small --pretrained_weights "checkpoint_['dis'].pth" --checkpoint_key "teacher" --output_dir out --batch-size 96 --lr 7.5e-6 --epochs 1 --data_set CIFAR10 --data_path data/CIFAR10
...
def get_args_parser():
    ...
    parser.add_argument('--data_path', default='data/CIFAR10', type=str,
                        help='dataset path')
    parser.add_argument('--data_set', default='IMNET', choices=['CIFAR10', 'IMNET', 'image_folder'],
                            type=str, help='ImageNet dataset path')
    parser.add_argument('--inat-category', default='name',
                        choices=['kingdom', 'phylum', 'class', 'order', 'supercategory', 'family', 'genus', 'name'],
                        type=str, help='semantic granularity')

    parser.add_argument('--output_dir', default='out/cls',
