...
# python3 -m torch.distributed.launch --nproc_per_node=1 eval_linear.py --pretrained_weights "checkpoint_['dis'].pth" --checkpoint_key "teacher"
...
def eval_linear(args):
    ...
    if args.arch == 'dalle_encoder':
        train_transform = pth_transforms.Compose([
            pth_transforms.RandomResizedCrop(32),
    ...
    dataset_train = datasets.CIFAR10(args.data_path, train=True, transform=train_transform)
    dataset_val = datasets.CIFAR10(args.data_path, train=False, transform=val_transform)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if epoch % args.val_freq == 0 or epoch == args.epochs - 1:
            ...
            if utils.is_main_process() and (test_stats["acc1"] >= best_acc):
                ...
                with (Path(args.output_dir) / f"log_{args.loss_functions}.txt").open("a") as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default="out/linear", help='Path to save logs and checkpoints')
